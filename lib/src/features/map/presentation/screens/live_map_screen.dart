                    ...
                    markers: [
                      ...
                      for (final c in clusters)
                        if (c.count == 1)
                          Marker(
                            point: c.point,
                            width: c.pins.first.isListing ? 148 : 42,
                            height: c.pins.first.isListing ? 32 : 42,
                            alignment: Alignment.center,
                            child: GestureDetector(
                              ...
                              child: c.pins.first.isListing
                                  ? MapListingPinMarker(
                                      title: c.pins.first.listing?.title ??
                                          'Listing',
                                      selected:
                                          _selected?.id == c.pins.first.id,
                                    )
                                  : MapProfilePinMarker(
                                      imageUrl:
                                          c.pins.first.profile?.avatarUrl,
                                      selected:
                                          _selected?.id == c.pins.first.id,
                                    ),
                            ),
