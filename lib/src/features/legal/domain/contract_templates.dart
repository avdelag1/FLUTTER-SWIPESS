...
const contractTemplates = <ContractTemplate>[
  ContractTemplate(
    ...
    description: 'Full residential lease with rent, deposit, utilities, pets, maintenance, termination, notices and signatures.',
    category: 'Lease',
    forRole: 'both',
    fields: _leaseFields,
  ...
  ContractTemplate(
    ...
    description: 'Sale document for motorcycle, bicycle, yacht or other asset with condition, price and transfer terms.',
    category: 'Purchase',
    forRole: 'both',
    fields: _saleFields,
  ...
  ContractTemplate(
    ...
    description: 'Loan repayment note with principal, interest, payment schedule, maturity and default terms.',
    category: 'Finance',
    forRole: 'both',
