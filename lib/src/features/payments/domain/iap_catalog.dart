...
/// Store catalog. Product IDs/prices stay compatible with the live stores;
/// marketplace copy follows the consent-first Direct Request model.
abstract final class IapCatalog {
  static const subscriptions = <IapOffer>[
    IapOffer(
      ...
      benefits: [
        ...
        'AI + AI Listing Creator',
        'Legal access & lawyer tools',
        'Events discovery & access',
        'Up to 5 active listings',
        'AI discoverability — found by service, price & reputation',
        'Profile Insights CRM (30 days)',
      ],
    ),
    IapOffer(
      ...
      benefits: [
        ...
        '2× profile views in feeds, map & search',
        'Profile Insights CRM (90 days)',
    ...
    IapOffer(
      ...
      benefits: [
        ...
        'First in AI & local search results',
        'Profile Insights CRM (1 year) + export',
      ],
    ),
  ];
  ...
  // Event products are intentionally untouched by the marketplace redesign.
