...
extension CheckoutResultX on CheckoutResult {
  ...
  String get userMessage => switch (this) {
    ...
    CheckoutResult.openedWebCheckout => 'PayPal opened — finish checkout there. Tokens refresh after the webhook.',
    CheckoutResult.complimentaryAccessActive => 'Your complimentary Premium access is still active. We won’t charge you for overlapping membership access.',
