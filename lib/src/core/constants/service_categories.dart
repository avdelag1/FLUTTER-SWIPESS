...
const serviceCategories = <ServiceCategory>[
  ...
  ServiceCategory(
      ...
      group: 'Home & Property'),
  ServiceCategory(
      value: 'house_painter', label: 'House Painter', group: 'Home & Property'),
  ServiceCategory(
      value: 'plumber', label: 'Plumber', group: 'Home & Property'),
  ServiceCategory(
      value: 'electrician', label: 'Electrician', group: 'Home & Property'),
  ServiceCategory(
      value: 'gardener',
  ...
  // Child & Pet Care
  ServiceCategory(
      value: 'nanny', label: 'Babysitter / Nanny', group: 'Child & Pet Care'),
  ServiceCategory(
      value: 'pet_care',
      label: 'Dog Sitter / Pet Sitter',
      group: 'Child & Pet Care'),
  ServiceCategory(
      value: 'pet_groomer', label: 'Pet Groomer', group: 'Child & Pet Care'),
  ...
  // Culinary & Events
  ServiceCategory(
      value: 'chef', label: 'Private Chef', group: 'Culinary & Events'),
  ServiceCategory(
      value: 'bartender',
  ...
  // Creative & Tech
  ServiceCategory(
      value: 'photographer', label: 'Photographer', group: 'Creative & Tech'),
  ServiceCategory(
      value: 'videographer',
  ...
  ServiceCategory(
      ...
      group: 'Professional'),
  ServiceCategory(
      value: 'security', label: 'Security Guard', group: 'Professional'),
  ServiceCategory(
      value: 'lawyer', label: 'Lawyer', group: 'Professional'),
