...
/// Kept separate from the header row so the deployment compiler sees a small,
/// independently balanced widget tree instead of deeply nested collection
/// literals around the token control.
class _TokenBalance extends StatelessWidget {
  const _TokenBalance({required this.balance, required this.ink});
